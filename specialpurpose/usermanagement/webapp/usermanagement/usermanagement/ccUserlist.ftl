...
<div class="screenlet">
	<form method="post" name="addprojectTypes" class="basic-form"  action="<@ofbizUrl>createProjectType</@ofbizUrl>"  >
		...
		<div class="screenlet-title-bar" >
      	 ...
      	 <div align="center"><h2><b><font color="blue"> User list</font></b></h2></div>   
	...
	<div class="screenlet-body">  
   		...
   		<tr>
	        ...
	        <h2><I><font color="blue">Search User</h2></font></I>
	       	</td>
	    </tr>
	    <tr>
		...
		<tr>
			<td class="label">User Login ID <b></b></td>
			<td><input type="text" name="LoginID" value=""   style="width:150px;"></td>
			<td class="label">First name <b></b></td>
			 <td><input type="text" name="firstName" value=""  style="width:150px;"></td>
	    <tr>
			<td colspan="4"  align="center">
			<input type="button" name="save" value="${uiLabelMap.CommonSearch}" onclick="javascript:addCourt('addprojectTypes')"/>
